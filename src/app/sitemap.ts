...
import { cityPages, projects, services, site, workComingSoon } from "@/content";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...(workComingSoon ? [] : projects).map((p) => ({ url: `${site.url}/radovi/${p.slug}`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.6 })),
